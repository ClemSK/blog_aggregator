...
func main() {
	...
	v1Router.Get("/feed_follows", apiCfg.middlwwareAuth(apiCfg.handlerGetFeedFollows))
	v1Router.Delete("/feed_follows/{feedFollowID}", apiCfg.middlwwareAuth(apiCfg.handlerDeleteFeedFollow))
